...
Ask only when the answer can change epic fit, scope, design, root cause, expected behavior, verification strategy, sequencing, risk, ownership, or the validation decision.
