...
Ask only when the answer can change validation safety, required environment, credentials, data, thresholds, ownership, or the validation decision.
...
If ambiguity is non-blocking, proceed with a clear assumption and record it in `docs/epics/active/<epic>/tasks.md`.
